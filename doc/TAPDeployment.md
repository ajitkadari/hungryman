...
```
tanzu accelerator create hungryman --git-repository https://github.com/ajitkadari/hungryman --git-branch main
```
...
hungryman-crawler        https://github.com/ajitkadari/hungryman.git   source-to-url   True    Ready    58m
